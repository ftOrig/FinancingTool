...
- (void)showStatus:(NSString*)status {
    ...
    if(self.alpha != alphaValue || self.hudView.alpha != alphaValue) {// dandy-
        ...
        __block void (^animationsBlock)(void) = ^{
            ...
            if(strongSelf) {
                ...
                strongSelf.alpha = alphaValue;
                strongSelf.hudView.alpha = alphaValue;
            }
        };
...
- (UIColor*)foregroundColorForStyle {
    ...
    } else if(self.defaultStyle == SVProgressHUDStyleDark) {// dandy

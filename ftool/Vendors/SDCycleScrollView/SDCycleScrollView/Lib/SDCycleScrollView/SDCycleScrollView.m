...
static NSString * const SDCycleScrollView_ID = @"cycleCell";
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[SDCollectionViewCell class] forCellWithReuseIdentifier:SDCycleScrollView_ID];
...
{
    SDCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:SDCycleScrollView_ID forIndexPath:indexPath];
